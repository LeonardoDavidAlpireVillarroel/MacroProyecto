...
{
    public class DynamicPursueAlgorithm:DynamicSeekAlgorithm
    {
        ...
        //CONSTRUCTOR
        public DynamicPursueAlgorithm(float maxAcceleration, float thresholdDistance, float limitPrediction)
